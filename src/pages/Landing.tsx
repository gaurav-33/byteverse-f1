...
export const Landing = () => {
    ...
    return (
        <div className="font-display bg-asphalt text-white min-h-screen overflow-x-hidden flex flex-col relative selection:bg-primary selection:text-white">
            ...
            {/* Abstract F1 Wireframe Background */}
            ...
            <section className="relative z-10 py-24 border-y border-white/5 bg-black/30">
                <div className="max-w-7xl mx-auto px-6">
                    {/* UPDATED UI: Matches Lead Organizers Heading */}
                    ...
                    <div className="space-y-20">
                        {currentSponsors.map((group, i) => (
                            <div key={i} className="relative">
                                ...
                                {/* Conditional Layout: Flex center for single items (Unstop), Grid for multiples */}
                                <div className={group.sponsors.length === 1 ? "flex items-center justify-center" : "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4"}>
                                    {group.sponsors.map((sponsor) => (
                                        ...
                                        >
                                            <img
                                                ...
                                                alt={sponsor.name}
                                                // Make the image slightly larger if it's a single sponsor
                                            ...
                                            {/* Fallback Initial Letter (if image fails) */}
